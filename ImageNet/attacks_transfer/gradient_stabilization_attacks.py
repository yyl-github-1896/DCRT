...
img_dir='/data/crq/DRL/ImageNet/val10000'
...
# # PGD (baseline)
# # save_dir = os.path.join('/data/crq/out','PGD','res50')
# # save_dir = os.path.join('/data/crq/out','PGD','incv3')
# save_dir = os.path.join('/data/crq/adv1000','PGD','res50')
...
# MI
# save_dir = os.path.join('/data/crq/out','MI','res50')
# save_dir = os.path.join('/data/crq/out','MI','incv3')
save_dir = os.path.join('/data/crq/kmean','MI',str(seed))
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
suc = np.zeros((3,num_iteration // check_point))
...
# NI
# save_dir = os.path.join('/data/crq/out','NI','res50')
# save_dir = os.path.join('/data/crq/out','NI','incv3')
save_dir = os.path.join('/data/crq/kmean','NI',str(seed))
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
suc = np.zeros((3,num_iteration // check_point))
...
# PI
# save_dir = os.path.join('/data/crq/out','PI','res50')
save_dir = os.path.join('/data/crq/kmean','PI',str(seed))
# save_dir = os.path.join('/data/crq/out','PI','incv3')
# save_dir = os.path.join('/data/crq/out','PI','res50eps8')
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
suc = np.zeros((3,num_iteration // check_point))
