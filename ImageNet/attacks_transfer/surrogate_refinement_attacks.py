...
# val_loader = torch.utils.data.DataLoader(MyDataset(img_dir='/data/crq/data/val_clean',
#         label_dir='/data/crq/data/val_rs.csv',
#         transform=transform,
...
## SGM
# save_dir = os.path.join('/data/crq/out','SGM','res50')
save_dir = os.path.join('/data/crq/kmean','SGM',str(seed))
...
# ## LinBP
# # save_dir = os.path.join('/data/crq/out','LinBP','res50')
# save_dir = os.path.join('/data/crq/out','LinBP','res50eps8')
# if not os.path.exists(save_dir):
#     os.makedirs(save_dir)
# pos = np.zeros((3,num_iteration // check_point))
# resnet = models.resnet50()
...
# save_dir = os.path.join('/data/crq/out','RFA','res50')
save_dir = os.path.join('/data/crq/kmean','RFA',str(seed))
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
pos = np.zeros((3,num_iteration // check_point))
resnet = models.resnet50()
...
# save_dir = os.path.join('/data/crq/out','IAA','res50')
save_dir = os.path.join('/data/crq/kmean','IAA',str(seed))
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
pos = np.zeros((3,num_iteration // check_point))
resnet = resnet50()
...
# ## DSM
# save_dir = os.path.join('/data/crq/out','DSM','res50')
# if not os.path.exists(save_dir):
#     os.makedirs(save_dir)
# pos = np.zeros((3,num_iteration // check_point))
